                                ...
                                //currentTrack(Track{})
{
    ...
    //WAIT
    gainSlider.addAndMakeVisible(gainLabel);
...
void Deck::resized()
{
    ...
    float buttonHeight = getHeight() - halfHeighStep*2.2;
    ...
    else
    {
        ...
        speedSlider.setBounds(widthStep*(widthSteps-1), 0, widthStep, getHeight());
