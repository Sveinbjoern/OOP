...
void Deck::paint (juce::Graphics& g)
{
    ...
    */
    ...
    {
        radius = heightStep * (heightSteps - 2)-20;
    }
    else
    {
        radius = widthStep * (widthSteps - 2)-20;
    }
    if (reverseLayout)
    {
        g.drawEllipse(widthStep * 2 + 10, heightStep + 10, radius, radius,2.0f);
        g.setFillType(juce::FillType(juce::Colour(juce::Colours::black)));

        g.fillEllipse(widthStep * 2 , heightStep+10, radius-5, radius-5);
        
    }
    else
    {
        
        g.drawEllipse(10, heightStep +10, radius, radius, 2.0f);
    }
    g.setFont (14.0f);
...
void Deck::resized()
{
    ...
    if (reverseLayout)
    {
        ...
        //vinyl.setBounds(widthStep*2, heightStep, widthStep * (widthSteps - 2), heightStep * (heightSteps - 2));
    ...
    else
    {
        ...
        //vinyl.setBounds(0, heightStep, widthStep * (widthSteps - 2), heightStep * (heightSteps - 2));
