...
PlaylistComponent::PlaylistComponent(juce::Button::Listener* _ButtonListener) : mainComponentButtonListener(_ButtonListener)
{
	...
	//tempTrack = tracks[3];
	//DBG("PlaylistComponent::PlaylistComponent tempTrack " << tempTrack.fullPath);
	//tracks[0] = tracks[3];
...
void PlaylistComponent::deleteTrack(int index)
{
	...
	//Delete the buttons in the tablelistbox
	//juce::Component* component = tableListBox.getCellComponent(1, index);
	//delete component;
	//component = tableListBox.getCellComponent(5, index);
	//delete component;
	//component = tableListBox.getCellComponent(6, index);
	//delete component;
