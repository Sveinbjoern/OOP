...
void PlaylistComponent::resized()
{
	...
	header.setColumnWidth(4, widthWithoutButtons - header.getColumnWidth(2) - header.getColumnWidth(3)-8);
...
Track* PlaylistComponent::getSearchedTrack(int index)
{
	return searchedTracks[index];
}
