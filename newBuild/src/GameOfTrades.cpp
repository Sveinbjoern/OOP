...
void GameOfTrades::mainInput(std::string overText)
{
    ...
    if (tokens.size() > 0)
    {
        ...
        {
            string text;
            text.append(advisorName);
            text.append("> ");
            text.append(tokens[0]);
            text.append(" is not a valid command. Please enter command, or type help for list of commands");
    ...
    } else 
    {
        string text;
        text.append(advisorName);
        text.append("> Please enter command, type help for list of commands");
